/// PLK (Plank) scoring tables with per-age and per-sex columns
/// and a fill-down rule, analogous to MDL/HRP/SDC implementations.
///
/// Source CSV format (20 columns):
/// Points, M17–21, F17–21, M22–26, F22–26, ..., M62+, F62+
///
/// Values are times in mm:ss. Longer (greater) times earn higher points.
...
///
/// Exposes:
/// - void loadPlkCsv(String csv)
/// - int plkPointsForSex(AftSex sex, int age, Duration time)
library plk_table;
...
/// Compute PLK points (0–100) for given sex, age and plank time.
