/// SDC (Sprint-Drag-Carry) scoring tables with per-age and per-sex columns
/// and a fill-down rule, analogous to MDL/HRP implementations.
///
...
///
/// Exposes:
/// - void loadSdcCsv(String csv)
/// - int sdcPointsForSex(AftSex sex, int age, Duration time)
library sdc_table;
...
/// Compute SDC points (0–100) for given sex, age and SDC time.
